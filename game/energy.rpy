...
label energy_minor_05:
    ...
    menu:
        e "(energy_minor_05) You read a Fast Company article on successful founders and their exercise habits. Set the alarm for an hour early and hit the gym?"
...
label energy_major_05:
    show player e at center
    menu:
        e "(energy_major_05) The product feature you have been working on is holding up this week's release. Work all night to catch up instead of delegating?"
